...
if(isset($_POST['ubah']) && $_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $result = $tahun_akademik->ubah_status($id);
    if($result === true){
...
if(isset($_POST['hapus']) && $_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($result === true){
        ...
        redirectWithMsg('../views/admin/data_tahun-akademik.php', 'Gagal menghapus! Tahun akademik ini masih digunakan oleh data mahasiswa.', 'danger');
    }else{
